...
/*
    ...
    Parameters:
        InstancePtr: Pointer to a PmodDHB1 object to set motor speeds for
        direction: if 0 turn left, greater than 0 turn right. 
*/

void DHB1_turn(PmodDHB1 *InstancePtr, u8 direction, u8 speed) {

    if(direction > 0){
        DHB1_setMotor1Speed(InstancePtr, speed);
        DHB1_setMotor2Speed(InstancePtr, 0);
    }
    else{
        DHB1_setMotor2Speed(InstancePtr, speed);
        DHB1_setMotor1Speed(InstancePtr, 0);
    }
